...
import com.wingedsheep.mtg.sets.definitions.vis.cards.CryptRats as cryptRatsResearchFixture
...
/**
 * Cross-card sweeper interactions against the canonical Visions Crypt Rats implementation.
 * Original eight assertion bodies are retained unchanged from the project-private baseline.
 * Source/rename boundary: ferocity-recycling/evidence/source-boundaries/canonical-rats-integration/.
 * Canonical card-only qualification remains in its era's CryptRatsScenarioTest.
 */
class RatsSweeperInteractionTest : ScenarioTestBase() {
