...
val engineSerializersModule = SerializersModule {
    ...
    polymorphic(GameEvent::class) {
        ...
        subclass(DungeonRoomEnteredEvent::class)
        subclass(DungeonCompletedEvent::class)
    ...
    polymorphic(AnswerContinuation::class) {
        ...
        subclass(VentureIntoDungeonContinuation::class)
    ...
    polymorphic(Component::class) {
        ...
        subclass(ActiveDungeonComponent::class)
        subclass(CompletedDungeonsComponent::class)
