...
class CascadeExecutor(
    ...
    override fun execute(
        ...
        val pause = if (hasPrototype) {
            // Prototype is a characteristic-changing cast choice, not an alternative cost. A card
            // hit by Cascade may therefore be cast without paying its mana cost either normally or
            // using Prototype characteristics. Keep that choice explicit rather than silently
            // defaulting a rules-legal cast to one characteristic set.
