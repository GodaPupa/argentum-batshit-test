// Scenario tests for cards from sets released in 2026 — the test-side mirror of `:mtg-sets:2026`.
//
...
//
// This depends on the `:mtg-sets` aggregator rather than `:mtg-sets:2026`: ScenarioTestBase builds
