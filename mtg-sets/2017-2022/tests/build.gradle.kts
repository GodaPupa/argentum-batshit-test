// Scenario tests for cards from sets released 2017–2022 — the test-side mirror of `:mtg-sets:2017-2022`.
//
...
//
// This depends on the `:mtg-sets` aggregator rather than `:mtg-sets:2017-2022`: ScenarioTestBase builds
