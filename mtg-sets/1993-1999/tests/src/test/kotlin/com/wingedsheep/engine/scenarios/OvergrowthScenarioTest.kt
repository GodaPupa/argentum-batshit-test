...
class OvergrowthScenarioTest : ScenarioTestBase() {

    init {
        test("Overgrowth adds two green when its land is tapped for mana") {
            val game = scenario()
                .withPlayers("Player", "Opponent")
                .withLandsOnBattlefield(1, "Forest", 1)
                .withCardAttachedTo(1, "Overgrowth", "Forest")
                .withActivePlayer(1)
            ...
            pool.getAmount(Color.GREEN) shouldBe 3
        }
    }
}
