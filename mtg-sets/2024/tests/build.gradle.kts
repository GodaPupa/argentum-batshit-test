// Scenario tests for cards from sets released in 2024 — the test-side mirror of `:mtg-sets:2024`.
//
...
//
// This depends on the `:mtg-sets` aggregator rather than `:mtg-sets:2024`: ScenarioTestBase builds
