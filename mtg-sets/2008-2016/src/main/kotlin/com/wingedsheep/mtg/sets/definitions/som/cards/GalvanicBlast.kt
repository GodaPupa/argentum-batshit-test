 ...
 *
 * Metalcraft is checked as the spell resolves. The conditional therefore wraps the damage effect
 * rather than restricting casting, and the two branches are alternatives so "instead" cannot deal
 * both 2 and 4 damage.
 */
