...
class RapidHybridizationScenarioTest : ScenarioTestBase() {
    ...
    private fun TestGame.assertOnlyToken(controllerNumber: Int) {
        ...
        projected.getSubtypes(token) shouldBe setOf("Frog", "Lizard")
    }

    init {
        test("destroys an opposing creature and gives its controller a 3/3 green Frog Lizard") {
            val game = scenario()
                .withPlayers("Caster", "Opponent")
                .withCardInHand(1, "Rapid Hybridization")
            ...
            game.castSpell(1, "Rapid Hybridization", target).error shouldBe null
            game.resolveWithoutErrors()

            game.isInGraveyard(2, "Grizzly Bears") shouldBe true
            game.isInGraveyard(1, "Rapid Hybridization") shouldBe true
