 ...
 *
 * This is observation, not a matchup benchmark. This sampling branch deliberately runs ten fixed seeds and
...
class BatshitEconomicsPreboardSmokeTest : FunSpec({
    ...
    test("ten fresh seeded preboard Argentum agent self-play games").config(
        enabled = enabled,
        timeout = 45.minutes,
    ) {
        ...
        val output = buildString {
            ...
            appendLine("Argentum agent self-play — fresh ten-game preboard smoke block")
