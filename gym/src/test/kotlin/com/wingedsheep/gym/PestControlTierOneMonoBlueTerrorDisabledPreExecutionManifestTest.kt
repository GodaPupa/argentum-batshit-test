...
class PestControlTierOneMonoBlueTerrorDisabledPreExecutionManifestTest : FunSpec({
    ...
    test("pre-execution manifest binds all accepted proofs and remains inert") {
        ...
        result.manifestSha256 shouldBe
    ...
    test("state substitution fails closed without activating anything") {
        val result =
            PestControlTierOneMonoBlueTerrorDisabledPreExecutionManifest.inspect(
                registry,
                "READY",
            )
