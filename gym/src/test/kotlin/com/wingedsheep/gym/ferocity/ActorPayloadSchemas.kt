...
internal object ActorPayloadSchemas {
    private val fields: Map<String, Set<String>> = mapOf(
        ...
        "com.wingedsheep.gym.ferocity.ActorAdditionalCostData" to setOf("description", "costType", "validSacrificeTargets", "sacrificeCount", "costAfterSacrifice", "validTapTargets", "tapCount", "tapBatchMaxActivations", "validDiscardTargets", "discardCount", "validBounceTargets", "bounceCount", "validExileTargets", "exileMinCount", "exileMaxCount", "exileMinTotalWeight", "exileCardWeights", "exileWeightUnit", "exileWeightPerTarget", "validBeholdTargets", "beholdCount", "validRevealTargets", "revealCount", "counterRemovalCreatures", "validBlightTargets", "blightAmount", "blightVariableMaxX", "payXLifeMaxX", "distributedCounterRemovalTotal", "validCraftMaterials", "craftMinCount", "craftMaxCount", "tapForPowerCreatures", "tapForPowerRequired"),
        "com.wingedsheep.gym.ferocity.ActorCombatCreature" to setOf("entityId", "attackingDefenderId", "attackingBandId", "blockingAttackerIds", "wasBlocked", "blockerIds", "orderedBlockerIds", "orderedAttackerIds", "assignedDamage", "dealtFirstStrikeDamage"),
        "com.wingedsheep.gym.ferocity.ActorCombatState" to setOf("creatures", "playersWhoDeclaredAttackers", "playersWhoDeclaredBlockers"),
        "com.wingedsheep.gym.ferocity.ActorConvokeCreatureData" to setOf("entityId", "name", "colors"),
        "com.wingedsheep.gym.ferocity.ActorCounterRemovalCreatureData" to setOf("entityId", "name", "availableCounters", "availableCountersByType", "imageUri"),
        "com.wingedsheep.gym.ferocity.ActorDelveCardData" to setOf("entityId", "name", "imageUri"),
        "com.wingedsheep.gym.ferocity.ActorHarmonizeCreatureData" to setOf("entityId", "name", "power"),
        "com.wingedsheep.gym.ferocity.ActorLegalAction" to setOf("action", "actionType", "description", "affordable", "validTargets", "requiresTargets", "targetCount", "minTargets", "targetDescription", "targetRequirements", "xConstrainsTargetManaValue", "xConstrainsTargetManaValueExactly", "xConstrainsTargetPower", "xConstrainsTargetCount", "validAttackers", "mandatoryAttackers", "validAttackTargets", "validBlockers", "blockerMaxBlockCounts", "mandatoryBlockerAssignments", "manaCostString", "manaCostPerExtraTarget", "hasXCost", "maxAffordableX", "minX", "additionalCostInfo", "hasConvoke", "convokeCreatures", "hasDelve", "delveCards", "minDelveNeeded", "hasTapForGeneric", "tapForGenericPermanents", "tapForGenericAmount", "tapForGenericLabel", "tapForGenericRequired", "hasHarmonize", "harmonizeCreatures", "isManaAbility", "requiresManaColorChoice", "availableManaColors", "autoTapPreview", "requiresDamageDistribution", "totalDamageToDistribute", "minDamagePerTarget", "sourceZone", "castsTransformed", "tapForPower", "tapForPowerRequired", "tapForPowerCreatures", "maxRepeatableActivations", "requiresForage", "additionalLifeCost", "modalEnumeration", "holdPriority"),
        "com.wingedsheep.gym.ferocity.ActorModalEnumerationMode" to setOf("index", "description", "available", "additionalManaCost", "additionalCostInfo", "targetRequirements"),
        "com.wingedsheep.gym.ferocity.ActorModalLegalEnumeration" to setOf("chooseCount", "minChooseCount", "allowRepeat", "additionalManaCostPerExtraMode", "additionalCostPerExtraMode", "modes", "unavailableIndices"),
        "com.wingedsheep.gym.ferocity.ActorObjectIdentity" to setOf("entityId", "generation"),
        "com.wingedsheep.gym.ferocity.ActorSourceCharacteristics" to setOf("name", "controllerId", "ownerId", "power", "toughness", "colors", "types", "subtypes", "keywords", "faceDown", "deathtouch", "lifelink"),
        "com.wingedsheep.gym.ferocity.ActorStackSource" to setOf("origin", "mode", "originalObjectIsCurrent", "currentVisibleObject", "characteristics"),
        "com.wingedsheep.gym.ferocity.ActorTapForGenericPermanentData" to setOf("entityId", "name", "isCreature"),
        "com.wingedsheep.gym.ferocity.ActorTapForPowerCreatureData" to setOf("entityId", "name", "power", "canAttack"),
        "com.wingedsheep.gym.ferocity.ActorTargetInfo" to setOf("index", "description", "minTargets", "maxTargets", "validTargets", "targetZone", "mustDifferFromEarlier", "xConstrainsManaValue", "xConstrainsManaValueExactly", "xConstrainsPower", "xConstrainsCount"),
    ...
    private val enumValues: Map<String, Set<String>> = mapOf(
        ...
        "com.wingedsheep.gym.ferocity.ActorSourceMode" to setOf("LIVE_BATTLEFIELD", "DEPARTED_BATTLEFIELD"),
