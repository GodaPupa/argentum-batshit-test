...
class PestControlTierOneSpyComboSupportBatchATest : FunSpec({
    test("five qualified definitions reduce the exact frozen Spy main queue from ten to five") {
        ...
        PestControlTierOneSpyComboAdmission.unresolvedMain(registry) shouldBe linkedMapOf(
            "Nyxborn Hydra" to 2,
            "Mesmeric Fiend" to 3,
            "Wall of Roots" to 3,
            "Land Grant" to 4,
