...
data class GrixisAuthorizedOfficialGame(
    val provenance: GrixisSmokeProvenance,
    val environment: GameEnvironment,
)

/**
 * First operational Grixis execution surface.
 *
 * It may initialize exactly one pre-authorized frozen assignment only after a durable attempt marker
 * exists. It never advances gameplay and it has no retry or replacement path.
 */
object PestControlTierOneGrixisAuthorizedInitializer {
    fun initialize(
