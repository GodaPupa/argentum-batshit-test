...
Replay all eight seeds for both Industrial lists and both seat rotations: 32 games total. Accept the
artifact only if all games complete without exceptions, rejected actions, or unapproved draw reasons.
