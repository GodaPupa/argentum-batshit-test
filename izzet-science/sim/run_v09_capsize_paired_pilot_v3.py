#!/usr/bin/env python3
"""Execute the sole frozen v0.9 Capsize-policy paired pilot v3."""
...
from paired_capsize_contract import aggregate_paired_games


CONTROL_SHA256="726f5e9458b46dda30b33a6ce9f3c3237b25d6e11b81dac85308c3065c108a01"
MASTER_SEED=0x1A22E7012
SAMPLES=10000
THROUGH=10
RETIRED=True
RETIRED_REASON=("Phase-14 seed 0x00000001A22E7012 is consumed; "
                "the accepted pilot is complete and may not be rerun")
...
def main() -> None:
    ...
    pairs=harness.iter_paired_capsize_policy_games(
        cards,SAMPLES,MASTER_SEED,THROUGH,False,True,False)
    summary=aggregate_paired_games(
        pairs,args.source_sha,MASTER_SEED,SAMPLES,harness.derive_paired_game_seed,THROUGH)
