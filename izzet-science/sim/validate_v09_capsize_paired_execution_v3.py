#!/usr/bin/env python3
"""Seed-free validation of the v3 paired runner and artifact provenance."""
...
RUNNER=ROOT/"izzet-science/sim/run_v09_capsize_paired_pilot_v3.py"
RETIRED_RUNNERS=(
...
RUNNER_SHA256="760ce035e6dc81fc001b2f080e87ebfda97be7444819a7a1e2fd7f3afb3eb5b3"
SOURCE="b"*40
WORKFLOW="c"*40
MASTER=1
SAMPLES=2
...
def main() -> None:
    ...
    if hashlib.sha256(RUNNER.read_bytes()).hexdigest()!=RUNNER_SHA256:
        raise SystemExit("frozen v3 runner hash mismatch")
    ...
    print("phase=commander-independent-readiness-14-paired-execution-freeze-v3")
    print("pilot_pairs=10000")
    print("master_seed=0x00000001A22E7012")
    ...
    print("disposition=V09_PHASE14_PREFLIGHT_VALIDATED")
