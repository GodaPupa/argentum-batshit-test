#!/usr/bin/env python3
"""Seed-free validation of the recovered paired runner and artifact provenance."""
...
RUNNER=ROOT/"izzet-science/sim/run_v09_capsize_paired_pilot_v2.py"
RETIRED_RUNNER=ROOT/"izzet-science/sim/run_v09_capsize_paired_pilot.py"
CONTROL=ROOT/"izzet-science/v0.7-control.md"
RUNNER_SHA256="2db5bdc6351836ffa3f5c76c98f9966b0a516fbeafc796eb9a2ae85f70932bbe"
SOURCE="b"*40
WORKFLOW="c"*40
MASTER=1
SAMPLES=2
...
def main() -> None:
    ...
    if hashlib.sha256(RUNNER.read_bytes()).hexdigest()!=RUNNER_SHA256:
        raise SystemExit("frozen recovered runner hash mismatch")
    if b"RETIRED=True" not in RETIRED_RUNNER.read_bytes():
    ...
    print("phase=commander-independent-readiness-11-paired-execution-freeze-v2")
    print("pilot_pairs=10000")
    print("master_seed=0x00000001A22E7011")
    print("payment_recovery_fixtures=3")
    ...
    print("disposition=V09_PHASE11_PREFLIGHT_VALIDATED")
