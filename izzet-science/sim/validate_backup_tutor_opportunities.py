#!/usr/bin/env python3
"""Seed-free Phase-3 gate for passive backup-tutor opportunity telemetry."""
...
def main() -> None:
    ...
    harness.backup_tutor_instrumentation_regressions(cards)
    print(f"control_sha256={CONTROL_SHA256}")
    print("phase=commander-independent-readiness-3-tutor-opportunity-preflight")
    print("legacy_trajectory_changes=0")
    print("tutor_executions=0")
