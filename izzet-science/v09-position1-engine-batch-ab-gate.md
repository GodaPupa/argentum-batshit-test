...
- Formal qualification reverified Afterlife semantics, the existing no-regeneration destroy plus
  target-controller flying-token rails, exact real-engine coverage, the frozen control hash, and
