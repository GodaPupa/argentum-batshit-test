#!/usr/bin/env python3
"""One-shot, fail-closed seed freezer for preboard Stage 1."""
...
OUT = QUAL / "preboard-stage1-seed-registry.json"
MATCHUPS = [
    ...
    ("mono-blue-faeries", "opponents/mono-blue-faeries-enz091-2026-09-19.dck"),
]
DIAGNOSTIC_SEEDS = set(range(710001, 710009))
...
def main() -> None:
    ...
    payload = {
        ...
        "authorization": {
            "capability_run": "https://github.com/GodaPupa/argentum-batshit-test/actions/runs/35522374363",
            "capability_artifact_sha256": "1eabbc83933e51f1618e99c50aaf481ff37e591721e79d1f630ac4b5e10450de",
