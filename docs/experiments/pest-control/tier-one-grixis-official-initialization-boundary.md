# Pest Control Tier-1 coverage — disabled official initialization boundary

## Purpose

This gate defines the request and validation boundary for a future official Grixis smoke
